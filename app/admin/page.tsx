...
type MemberCountRow = { team_id: string };
...
async function loadDashboard() {
  ...
  const { data: teams, error: teamsErr } = await supabase
    .from('teams')
    .select('id, team_name, captain_name, captain_contact, contact_type, province, join_code, status, created_at')
  ...
  (members as MemberCountRow[] | null)?.forEach((m) => {
